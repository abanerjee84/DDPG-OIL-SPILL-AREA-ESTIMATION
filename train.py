...
class Trainer:
	...
	def save_models_best(self):
		...
		:return:
		"""
		torch.save(self.target_actor.state_dict(), './Models/best_actor.pt')
		torch.save(self.target_critic.state_dict(), './Models/best_critic.pt')
		print ('Models saved successfully')
	...
	def load_models_best(self):
		...
		:return:
		"""
		self.actor.load_state_dict(torch.load('./Final_Res/best_actor_final.pt'))
		self.critic.load_state_dict(torch.load('./Final_Res/best_critic_final.pt'))
		utils.hard_update(self.target_actor, self.actor)
		utils.hard_update(self.target_critic, self.critic)
		print ('Models loaded succesfully')
